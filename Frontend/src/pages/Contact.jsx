    ...
    <div>
        ...
        <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
          ...
          <div className='flex flex-col justify-center items-start gap-6'>
            ...
            <p className='text-gray-500'>54709 Gaishar <br /> Itahari, Nepal</p>
            <p className='text-gray-500'>Tel : (+977) 9817000000 <br /> Email: admin@forever.com</p>
            <p className='font-semibold text-xl text-gray-600'>Careers at LetsShop</p>
